...
class ArticlesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'author_name' => ['type' => 'string', 'length' => 127, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'publish_date' => ['type' => 'datetime', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
        '_constraints' => [
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'publish_date' => '2019-12-04 17:32:05'
            ],
        ];
        parent::init();
    }
